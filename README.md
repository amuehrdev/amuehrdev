...
| Layer | Tools |
|---|---|
| Frontend | TypeScript, React, Next.js, Tailwind, Vitest, Playwright |
| Backend | Python, FastAPI, SQLAlchemy, PostgreSQL, NATS |
| Voice & AI | Retell, LLM pipelines for transcript analysis, structured extraction |
| Ops | Kubernetes, GitOps, SigNoz, GitHub Actions |

## How I like to work

- Ship small, verify live, write down what surprised you so the next person doesn't trip over it.
- Design for the person on the phone at 7 pm with a burst pipe, not for the demo.
- German UI, English code, three languages in every string.

📫 alexander.muehr@cambioo.ai · 📍 Vienna, Austria
